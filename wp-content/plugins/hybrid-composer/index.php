...
<footer class="default-wp-footer">
    <div class="content">
        <div class="container">
            <div><?php echo esc_attr__("Copyright Schiocco | All Rights Reserved | Powered by","hc") ?> <a href="<?php echo esc_url("http//wordpress.org") ?>"><?php echo esc_attr("WordPress")?></a></div>
        </div>
    </div>
</footer>  
<?php } else { ?>
